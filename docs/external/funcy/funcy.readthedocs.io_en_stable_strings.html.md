---
url: "https://funcy.readthedocs.io/en/stable/strings.html"
title: "String utils — funcy 2.0 documentation"
---

- »
- String utils
- [Edit on GitHub](https://github.com/Suor/funcy/blob/13fac0037c109a9e4649fc8ee343be17647f7407/docs/strings.rst)

* * *

# String utils [¶](https://funcy.readthedocs.io/en/stable/strings.html\#string-utils "Permalink to this headline")

re\_find( _regex_, _s_, _flags=0_) [¶](https://funcy.readthedocs.io/en/stable/strings.html#re_find "Permalink to this definition")
...
re\_test( _regex_, _s_, _flags=0_) [¶](https://funcy.readthedocs.io/en/stable/strings.html#re_test "Permalink to this definition")

Tests whether `regex` can be found in `s`.

re\_all( _regex_, _s_, _flags=0_) [¶](https://funcy.readthedocs.io/en/stable/strings.html#re_all "Permalink to this definition")re\_iter( _regex_, _s_, _flags=0_) [¶](https://funcy.readthedocs.io/en/stable/strings.html#re_iter "Permalink to this definition")

Returns a list or an iterator of all matches of `regex` in `s`. Matches are presented in most simple form possible, see table in [`re_find()`](https://funcy.readthedocs.io/en/stable/strings.html#re_find) docs.
...
re\_finder( _regex_, _flags=0_) [¶](https://funcy.readthedocs.io/en/stable/strings.html#re_finder "Permalink to this definition")

Returns a function that calls [`re_find()`](https://funcy.readthedocs.io/en/stable/strings.html#re_find) for its sole argument. Its main purpose is quickly constructing mapper functions for [`map()`](https://funcy.readthedocs.io/en/stable/seqs.html#map) and friends.

See also [Extended function semantics](https://funcy.readthedocs.io/en/stable/extended_fns.html#extended-fns).

re\_tester( _regex_, _flags=0_) [¶](https://funcy.readthedocs.io/en/stable/strings.html#re_tester "Permalink to this definition")

Returns a function that calls [`re_test()`](https://funcy.readthedocs.io/en/stable/strings.html#re_test) for it’s sole argument. Aimed at quick construction of predicates for use in [`filter()`](https://funcy.readthedocs.io/en/stable/seqs.html#filter) and friends.

See also [Extended function semantics](https://funcy.readthedocs.io/en/stable/extended_fns.html#extended-fns).

str\_join(\[ _sep=""_, \] _seq_) [¶](https://funcy.readthedocs.io/en/stable/strings.html#str_join "Permalink to this definition")

Joins sequence with `sep`. Same as `sep.join(seq)`, but forcefully converts all elements to separator type, `str` by default.

See also [`joining()`](https://funcy.readthedocs.io/en/stable/flow.html#joining).

cut\_prefix( _s_, _prefix_) [¶](https://funcy.readthedocs.io/en/stable/strings.html#cut_prefix "Permalink to this definition")

Cuts prefix from given string if it’s present.

cut\_suffix( _s_, _suffix_) [¶](https://funcy.readthedocs.io/en/stable/strings.html#cut_suffix "Permalink to this definition")
...
Versions[latest](https://funcy.readthedocs.io/en/latest/strings.html)**[stable](https://funcy.readthedocs.io/en/stable/strings.html)**[2.0](https://funcy.readthedocs.io/en/2.0/strings.html)[1.18](https://funcy.readthedocs.io/en/1.18/strings.html)[1.17](https://funcy.readthedocs.io/en/1.17/strings.html)[1.16](https://funcy.readthedocs.io/en/1.16/strings.html)[1.15](https://funcy.readthedocs.io/en/1.15/strings.html)[1.14](https://funcy.readthedocs.io/en/1.14/strings.html)[1.13](https://funcy.readthedocs.io/en/1.13/strings.html)[1.11](https://funcy.readthedocs.io/en/1.11/strings.html)[1.10.3](https://funcy.readthedocs.io/en/1.10.3/strings.html)[1.10.2](https://funcy.readthedocs.io/en/1.10.2/strings.html)[1.10.1](https://funcy.readthedocs.io/en/1.10.1/strings.html)[1.10](https://funcy.readthedocs.io/en/1.10/strings.html)[1.9](https://funcy.readthedocs.io/en/1.9/strings.html)[1.8](https://funcy.readthedocs.io/en/1.8/strings.html)[1.7.5](https://funcy.readthedocs.io/en/1.7.5/strings.html)[1.7.4](https://funcy.readthedocs.io/en/1.7.4/strings.html)[1.7.3](https://funcy.readthedocs.io/en/1.7.3/strings.html)[1.7.2](https://funcy.readthedocs.io/en/1.7.2/strings.html)[1.7.1](https://funcy.readthedocs.io/en/1.7.1/strings.html)[1.7](https://funcy.readthedocs.io/en/1.7/strings.html)[1.6](https://funcy.readthedocs.io/en/1.6/strings.html)[1.5](https://funcy.readthedocs.io/en/1.5/strings.html)[1.4](https://funcy.readthedocs.io/en/1.4/strings.html)[1.3](https://funcy.readthedocs.io/en/1.3/strings.html)[1.1](https://funcy.readthedocs.io/en/1.1/strings.html)[1.0.0](https://funcy.readthedocs.io/en/1.0.0/strings.html)[0.10.1](https://funcy.readthedocs.io/en/0.10.1/strings.html)On Read the Docs[Project Home](https://app.readthedocs.org/projects/funcy/?utm_source=funcy&utm_content=flyout)[Builds](https://app.readthedocs.org/projects/funcy/builds/?utm_source=funcy&utm_content=flyout)Search
